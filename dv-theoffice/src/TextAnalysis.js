  ...
  return (
    <div className="container">
      <div className="text">
        ...
        <p>Here's a visual representation that reveals unique patterns in the characters’ speech styles. Explore it to identify correlations, compare speech traits across characters, and uncover insights that align with their personalities and roles in the show.</p><br></br>
